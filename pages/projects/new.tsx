                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          {!canCreateProjectFromBalance && !hasSubscriptionProject && !isUnlimited ? (
                            <button
                              ...
                              className="inline-flex min-h-[34px] items-center justify-center rounded-full border border-[#88b88d] bg-[#edf6ea] px-3 py-1 text-xs font-semibold text-[#2f4c32] shadow-sm transition hover:bg-[#e3f1de] disabled:cursor-not-allowed disabled:opacity-60"
                            >
                              {paymentBusyKey === "topup" ? "Открываю оплату..." : `Пополнить на ${formatRubAmount(PROJECT_CREATION_PRICE_RUB)}`}
                            </button>
                          ) : null}
