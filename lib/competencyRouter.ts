...
export const COMPETENCY_ROUTES: CompetencyRoute[] = [
  ...
  },
  {
    ...
    "name": "Лидерство / лидерский потенциал",
  ...
  },
  {
    "id": "C32",
    "cluster": "Мышление и обучение",
    "name": "Проектное мышление",
    "definition": "Умение видеть задачу как проект: цель, этапы, ресурсы, ограничения, риски, контрольные точки и понятный ожидаемый результат.",
    "linkedGoals": [
      "role_fit",
      "management_potential",
      "self_organization",
    ...
    "fitGate": "Считать сильным, когда человек не только предлагает идею, но раскладывает её на этапы, видит зависимости, ресурсы и риски, а также может объяснить первые практические шаги."
  }
] as CompetencyRoute[];

export type CompetencySelectionPreset = {
  id: string;
  title: string;
  description: string;
...
export const COMPETENCY_SELECTION_PRESETS: CompetencySelectionPreset[] = [
  {
    id: "standard_hiring",
    title: "Стандарт подбора",
    description: "Базовый набор для подбора по компетенциям: проектное мышление, результат, ответственность, команда, клиентский фокус, лидерство и делегирование.",
    competencyIds: [
      "C32",
      "C09",
      "C10",
  ...
  {
    id: "managerial_hiring",
    title: "Руководитель / старший",
    description: "Усиленный управленческий набор: лидерство, ситуативное руководство, делегирование, координация, развитие людей и переговоры.",
    competencyIds: [
      "C25",
      "C26",
      "C27",
