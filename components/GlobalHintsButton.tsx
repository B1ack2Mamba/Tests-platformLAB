...
export function GlobalHintsButton() {
  ...
  return (
    <>
      ...
      {notice ? (
        <div className="fixed bottom-[132px] right-5 z-[900] max-w-[260px] rounded-2xl border border-slate-200 bg-white/95 px-4 py-3 text-sm leading-5 text-slate-700 shadow-lg backdrop-blur">
